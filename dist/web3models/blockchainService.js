...
exports.getAccounts = exports.getBlockNumber = exports.getEthBalance = void 0;
...
const getBlockNumber = () => __awaiter(void 0, void 0, void 0, function* () {
    const lastBlock = yield web3Client_1.default.eth.getBlockNumber();
    return lastBlock;
});
exports.getBlockNumber = getBlockNumber;
const getAccounts = () => __awaiter(void 0, void 0, void 0, function* () {
    const accounts = yield web3Client_1.default.eth.getAccounts();
    return accounts;
});
